...
// ApplicationPackageReq defines model for ApplicationPackageReq.
type ApplicationPackageReq struct {
	ApiVersion string                 `json:"apiVersion"`
	Kind       string                 `json:"kind"`
	Metadata   Metadata               `json:"metadata"`
	Spec       ApplicationPackageSpec `json:"spec"`
...
// ApplicationPackageResp defines model for ApplicationPackageResp.
type ApplicationPackageResp = ApplicationPackage
